...
void loop() {  ////// Г Л А В Н Ы Й  Ц И К Л  П Р О Г Р А М М Ы ///////////////////////////////////
  ...
  if (r == 0 && q == 2 && digitalRead(A1) == 0) {
    ...
    if (y == 35 && b >= 4) {
      ...
      u8g2.setCursor(0, 13);
      y = 700;
      tone(9, y);  // на 9 пине создаем сигнал 700 герц
